...
<form action="login.php" method="post">
			...
			<font style=" font:bold 40px 'Aleo';"><center> Cafe NUST POS</center></font>
		<br>
...
<div>
	<span style="height:30px; width:25px;" class="add-on"><i class="icon-lock icon-2x"></i></span><input type="password" style="height:40px;" name="password" Placeholder="Password" required/><br>
		...
		<div class="qwe">
		 <button class="btn pull-center" href="dashboard.html" type="submit"><i class="icon-signin icon-large"></i> Login</button>
</div>
		 </form>
</div>
</div>
