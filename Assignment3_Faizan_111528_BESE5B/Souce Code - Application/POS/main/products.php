...
function sum() {
            ...
            var txtFirstNumberValue = document.getElementById('txtB').value;
            var txtSecondNumberValue = document.getElementById('txtA').value;
            var result = parseInt(txtFirstNumberValue) - parseInt(txtSecondNumberValue);
            if (!isNaN(result)) {
                document.getElementById('txtC').value = result;
            ...
            var result = parseInt(txtFirstNumberValue) * parseInt(txtSecondNumberValue);
            if (!isNaN(result)) {
                document.getElementById('am').value = result;
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: center;">
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				$result = $db->prepare("SELECT *, amount as amount FROM products ORDER BY product_id DESC");
				$result->execute();
