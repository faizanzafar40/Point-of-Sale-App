...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="sidebar-nav">
			...
			<li class="active"><a href="employee_admin.php"><i class="icon-group icon-2x"></i> Employees</a>                                    </li>
...
<?php 
			...
			Total Number of Employees: <font color="blue" style="font:bold 22px 'Aleo';"><?php echo $rowcount;?></font>
			</div>
</div>
